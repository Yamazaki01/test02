		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="#premiunm">Only Premium</a></li>
				</ul>
		...
		<div class="row">
			<div class="col-xs-7 col-sm-7 col-md-7">
				...
				<font size="3" color="#424242">
					...
					焙煎なしでの販売も承っております。是非お好みのローストをお探し、ご注文下さい。<br><br><br>
				</font>
			</div>
	...
	<div class="row">
		<div
			...
			<s:form action="BackStoreListAction" onSubmit="return check()">
				<input type="submit" class="btn btn-info btn-lg" value="　戻る　">
			</s:form>
		</div>
	</div>
	<br>
		...
		<div class="container">
			...
			<table class="table table-bordered table-hover">
				<tr>
					...
					<th class="col-xs-1 col-sm-1 col-md-1">購入 <s:iterator
							value="#session.goodsInfoList">
							<tr>

								<td><a id="premium"><s:property value="beanName" /> <s:form
