...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-xs-6"height:600px;">
				<div align="center">
					<s:form action="InsertUserInfoAction" name="insert">
						...
						<div class=formWidth>
							...
							氏名<br> <input name="name" value="<s:property value="name" />" class="form-control"
								placeholder="氏名" required pattern="\S{1,50}"onkeyup="userInfoLengthCheck();" title="スペース無し、30文字以内でお願いします。" /><br>
							電話番号<br> <input name="phoneNumber" value="<s:property value="phoneNumber" />" class="form-control"
								type="tel" placeholder="000-0000-0000" required pattern="\d{1,11}" onkeyup="userInfoLengthCheck();"
							...
							パスワードの再入力<br> <input name="premiumPassRekey" value="<s:property value="premiumPassRekey" />"
								class="form-control" type="password" placeholder="パスワード" requireds pattern="^(?=.*[0-9])(?=.*[a-z])[0-9a-z\-]{6,30}$"
								onkeyup="userInfoLengthCheck();" title="6文字以上30文字です。半角数字、半角英小文字、ハイフンを使用してください。数字、英小文字の混在の必要があります" /><br>
					...
					<s:token />
						...
						<div class=formWidth>
							...
							変更後の電話番号<br> <input name="editPhoneNumber"
								...
								class="form-control" type="tel" placeholder="000-0000-0000"
								required pattern=".{1,11}" onkeyup="userInfoLengthCheck();"
	...
	<div class="row">
		<div class="col-xs-12"height:80px;">
			<div align="center">
				<s:form action="LogoutAdminAction">
					<input type="submit" class="btn btn-default" value="ログアウト"/><br>
				</s:form>
				<br><br><br>
			</div>
		</div>
