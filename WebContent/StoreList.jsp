...
<body onload="initialize()" onunload="GUnload()">
			...
			<div id="wrapper">
				<div id="slideshow">
					<div class="slideContents">
						<section id="slide1"><img src="img/popslide/Top1.jpg"></section>
						<section id="slide2"><img src="img/popslide/Top2.jpg"></section>
						<section id="slide3"><img src="img/popslide/Top3.jpg"></section>
						<section id="slide4"><img src="img/popslide/Top4.jpg"></section>
						<section id="slide5"><img src="img/popslide/Top5.jpg"></section>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container" align="center">
		...
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div class="wow animated zoomIn"><h2>美味しいコーヒーを探す旅へようこそ！</h2></div>
	...
	<div class="container">
		<div class="well">
			...
			<div class="row">
				...
				<!-- FacebookPage Plugin -->
			<div class="fb-page" align="center" class="col-md-6 col-xs-12" 
				data-href="https://www.facebook.com/Stardusts.cafe"
				data-width="450" data-height="600" data-hide-cover="false"
		...
		<div class="row">
			<div class="col-md-8 col-xs-12">
				...
				<form class="form-horizontal" name="mail">	
					...
					<div class="form-group">
						<input type="text" name="mailNo" class="form-control" placeholder="example@gmail.com" required/>
					</div>	
					<span class=" glyphicon glyphicon glyphicon-pencil"> お問い合わせ内容
						※必須</span>
					<div class="form-group">
						<textarea name="inquiry" class="form-control" rows="10" required></textarea>
					</div>	
					<div class="form-group">
					<input type="button" class="btn btn-primary" value="送信" onClick="sendMail()" />
					</div>
				</form>
			</div>
		</div>
