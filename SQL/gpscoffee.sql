...
insert into store_list(shop_id,shop_name,zipcode,shop_address,shop_number,administrator_id,administrator_pass,administrator_name)value(23,'小岩ポポ店（デバッグ用/商品データなし）','133-0056','東京都江戸川区南小岩6-31-2','06-0391-1185','test','koiwapopo','江戸川一郎');
