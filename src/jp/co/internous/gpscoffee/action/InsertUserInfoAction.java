...
public class InsertUserInfoAction extends ActionClass {
	...
	public String execute(){
		...
		boolean checkID = InsertUserInfoDao.isCheckID(premiumId);
		boolean checkPass = InsertUserInfoDao.isCheckPassword(premiumPass, premiumPassRekey);
		if(checkID){
			if(checkPass){
				InsertUserInfoDao.insertPremiumMembership(premiumId,premiumPass,name,phoneNumber);
				notice = "登録が完了しました。";
				result = SUCCESS;
			}else{
