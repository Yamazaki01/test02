...
public class InsertUserInfoDAO extends DaoClass {
     ...
     */
    public boolean isCheckID(String premiumId){
        res = true ;
        try{
     ...
     * @return 必ず実行結果を返す
     */
    public boolean isCheckPassword(String premiumPass,String premiumPassRekey){
     ...
     */
    public void insertPremiumMembership(String premiumId,String premiumPass,String name,
            String phoneNumber){
        try{
            con = DBconnector.getConnection();
